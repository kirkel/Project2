...
#		
  #Scenario: test the create a batch
    ...
    #And the user clicks on the X button on the create batch screen
    #Then the user should see the manage batch page
    #And the user clicks on create batch
  ...
  Scenario Outline: add a new batch
    And the user clicks on create batch
    Given the training type "<batch_trainingType>" is valid
    Given the skill type "<batch_skillType>" is valid
    Given the location "<batch_location>" is valid
    Given the trainer "<batch_trainer>" is valid
    Given the cotrainer "<batch_cotrainer>" is valid
    Given the trainer "<batch_trainer>" and cotrainer "<batch_cotrainer>" are not the same
    Given the year "<batch_startYear>" is valid
    Given the start date "<batch_startMonth>" "<batch_startDay>" "<batch_startYear>" is before the end date "<batch_endMonth>" "<batch_endDay>" "<batch_endYear>"
    Given the good grade "<batch_goodGrade>" is higher than the passing grade "<batch_passingGrade>"
    ...
    Then the user should see the correct "<batch>" given the correct starting year "<batch_startYear>" and correct training name "<batch_trainingName>"
